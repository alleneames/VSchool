...
#Actions
  ...
  - get action
#Reducers
  - change the state of App based on each action
#Index.js
  - links App to Provider
  - render form-container
  - render todo-list container
#Form-container
  - link submit action via props from the Store
  - contain local controlled state of the form components
  - render form component
  - pass down the handle change function and submit action via props
#Form-component
  - rendering actual html in the form of inputs and buttons with their respective event handlers (onChange and onSubmit)
#Todo-list-container
  - link the array of todos via props (get action) from store
  - render the todo-list component
  - pass down the todo list via props to todo-list component
#Todo-list-component
  - renders each individual todo-item-container
  - passes down each individual todo item via props (along with index, key, etc.)
#Todo-item-container
  - renders each todo-item-component
  - contain local controlled state of the individual todo-item components
  - render todo-component
  - pass down the handle change function, remove function, and edit submit function via props
#Todo-item-component
  - renders the actual todo data ALL the way from the list-containers
  - displays edit inputs and remove buttons in actual html with their respective event handlers (onChange, onSubmit, onClick)
